...
function setupNavigation() {
    ...
    document.querySelectorAll("[data-page-link]").forEach(function (button) {
...
function generatePaymentQR() {
    ...
    const upiUrl =
        ...
        "&cu=INR" +
        "&tn=" +
        encodeURIComponent(`${plan} Subscription`);
...
function viewCustomer(id) {
    ...
    if (details) {
        ...
        details.innerHTML = `
            ...
            <div class="detail-row">
                <span>Password</span>
                <strong>${escapeHTML(customer.password)}</strong>
            </div>

            <div class="detail-row">
                <span>Plan</span>
                <strong>${escapeHTML(customer.plan)}</strong>
            </div>
...
function changePaymentStatus(
    ...
    addNotification(
        "Payment Updated",
        `${payment.customerName} payment marked as ${status}.`,
        status === "Paid"
            ? "success"
            : "warning"
    );
                    ...
                    <div>
                        ...
                        ${
                            ...
                            ? `
                                <p>
                                    Registration No:
                                    ${escapeHTML(settings.businessRegistrationNo)}
                                </p>
                            `
                            : ""
                        }
...
function updateDashboard() {
    ...
    setText("activeCustomers", active);

    setText("expiredCustomers", expired);

    setText("expiringSoon", expiring);
...
function renderExpiringCustomers() {
    ...
    list.innerHTML =
        expiring.map(function (customer) {
    ...
    if (general) {
        ...
        general.addEventListener(
            ...
            function () {
                ...
                settings.defaultPortal =
                    getValue("defaultPortal");

                settings.whatsappNumber =
                    getValue("whatsappNumber");
...
function getCurrentStatus(customer) {
...
function isExpiringSoon(customer) {
    ...
    if (
        !customer.expiryDate ||
        getCurrentStatus(customer) !== "Active"
    ) {
